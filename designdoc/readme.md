...
- **Что делаем с технической точки зрения:** Решаем задачу регрессии, чтобы прогнозировать цену на нефть на следующий день, на неделю и на месяц. Для этого используем исторические данные о ценах на нефть, объемах торгов и другие возможно релевантные временные ряды.

#### 2.2. Блок-схема решения  
Текстовое описание блок-схема для бейзлайна и основного MVP:

- **Сбор данных:** Автоматическое получение исторических данных о ценах на нефть и объемах торгов.
- **Предварительная обработка:** Очистка данных, обработка пропусков, нормализация и стандартизация.
- **Разведочный анализ данных (EDA):** Визуализация и статистический анализ временных рядов, определение трендов, сезонности и аномалий.
- **Инженерия признаков:** Создание новых признаков, таких как скользящие средние, разница между максимальной и минимальной ценами.
- **Разделение данных:** Разбиение данных на обучающую, валидационную и тестовую выборки.
- **Выбор модели:** Оценка различных алгоритмов машинного обучения для регрессии временных рядов.
- **Обучение модели:** Тренировка модели на обучающем наборе данных с использованием кросс-валидации.
- **Оптимизация и тюнинг:** Подбор гиперпараметров для улучшения производительности модели.
- **Тестирование модели:** Оценка производительности на тестовой выборке.
- **Интерпретация результатов:** Анализ важности признаков и вклада в прогноз. 
